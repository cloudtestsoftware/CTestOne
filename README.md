...
CloudTestSoftware has built an automation framework which can create injectors and also can be built complex automation tests using browser, web service, database , Java Script, Java, Python  etc. If you want to build simple TestNg / Junit Tests or Selenium WebDriver tests please refer to the last section of this document.

If you find any issue, please create a ticket using ISSUEs. Also please use the 

## Steps for browser Automation Tests using CTO recording tool 
...
To use this framework to build quick browser automation tests using TestNg or Junit follow these simple steps
    ...
    10) Install CTestOne (CTO) recoder as chrome plugin using this link [ CTO Recording Tool](https://chrome.google.com/webstore/search/CloudTestSoftware)
